...
import br.com.foursys.fourcamp.fourstore.controller.MenuValidate;
...
public class MainMenu {
	...
	MenuValidate validate = new MenuValidate();
	
	public void mainMenu() {
		
		System.out.print("Login: ");
		String loginTyped = sc.nextLine();
		System.out.print("Senha: ");
		int passwordTyped = sc.nextInt();
		

		if (validate.ValidateLogin(loginTyped,passwordTyped)) {
	...
	public void userCallSell() {
		...
		ArrayList <Integer> listQtt = new ArrayList<Integer>();
		...
		System.out.println("Deseja prosseguir digite 1");
		...
		System.out.println(transactionController.sell(listSku, listQtt, CPF, paymentMethod, paymentData));
