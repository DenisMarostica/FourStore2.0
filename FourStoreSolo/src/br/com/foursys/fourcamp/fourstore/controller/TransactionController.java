...
public class TransactionController {
	...
	public String sell(ArrayList<String> sku, ArrayList<Integer> qtt, String CPF, Integer paymentMethod, String paymentData) {
		String result = "";
		...
		for(int i=0;i<sku.size();i++) {
			...
			Product product = new Product(sku.get(i), qtt.get(i));
			listProduct.add(product);
			
		}
		//cria objeto com os dados digitados pelo usuário
		Transaction transaction = new Transaction(updatedPayment, paymentData, 0.0, CPF, listProduct);
